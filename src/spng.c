...
const char *spng_strerror(int err)
{
    switch(err)
    {
        ...
        case SPNG_EWIDTH: return "invalid image pixwidth";
        case SPNG_EHEIGHT: return "invalid image pixheight";
        case SPNG_EUSER_WIDTH: return "image pixwidth exceeds user limit";
        case SPNG_EUSER_HEIGHT: return "image pixheight exceeds user limit";
